...
<%-- 수출입 은행 환울 정보 중 EUR,JSP(100),CNH,USD.jsp 형태로 출력하기 --%>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
<title>수출입 은행 환율 정보 조회 예제</title>
<style type="text/css">
table {
 ...
 List<List<String>> trlist = new ArrayList<List<String>>();
	...
	try {
		...
		for (Element tr : trs) {
			...
			if(tdlist.size() > 0) {
				if(tdlist.get(0).equals("EUR") || tdlist.get(0).equals("JSP(100)") ||
	...
	pageContext.setAttribute("trlist", trlist); //EL에서 사용하기 위한 속성 등록
	pageContext.setAttribute("title", title);  //EL에서 사용하기 위한 속성 등록
	%>
	<table>
